...
* v3.1.6
  + bugfix: data types of some metrics changed in newer versions of mongoDB which may have lead to java.lang.ClassCastException which is now fixed once for all by using generics (see also [#13](/../../issues/13))  
* v3.1.5
